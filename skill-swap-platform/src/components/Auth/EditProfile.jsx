    ...
    const fetchData = async () => {
      try {
        ...
        if (userDoc.exists()) {
          ...
          setSelectedContactTypes(Object.keys(userData.contactMethods || {}));
          ...
          setSkillsIHave(skillsIHaveDocs.map(doc => ({ id: doc.id, name: doc.data().name })));
          setSkillsIWant(skillsIWantDocs.map(doc => ({ id: doc.id, name: doc.data().name })));
        }
